...
export default function DivisionGamePage() {
    ...
    const generateProblem = () => {
        const newDividend = Math.floor(Math.random() * 90) + 10; // 10–99
        const newDivisor = Math.floor(Math.random() * 8) + 2; // 2–9 (no 1)
    ...
    const checkAnswer = () => {
        ...
        if (parseInt(quotient) === q && parseInt(remainder) === r) {
            setFeedback("correct");
    ...
    return (
        <div className="w-screen h-screen flex flex-col items-center justify-center bg-[#f7f9fc] text-gray-900 relative">
            ...
            <h1 className="text-4xl font-extrabold mb-6">➗ Division Game</h1>
            ...
            <div className="bg-white p-10 rounded-3xl shadow-xl text-center w-96">
                ...
                <input
                    ...
                    className="w-full text-center text-2xl border-2 rounded-xl p-3 outline-none focus:ring-4 focus:ring-blue-300 mb-3"
