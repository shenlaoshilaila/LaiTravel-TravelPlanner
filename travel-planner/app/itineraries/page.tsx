...
export default function ItinerariesPage() {
    ...
    const fetchMyItineraries = async () => {
        try {
            ...
            const response = await fetch("https://travelplanner-720040112489.us-east1.run.app/api/itinerary/mine", {
                method: "GET",
                credentials: "include",
    ...
    const deleteItinerary = async (id: string) => {
        ...
        try {
            const res = await fetch(`https://travelplanner-720040112489.us-east1.run.app/api/itinerary/${id}`, {
                method: "DELETE",
                credentials: "include",
            });
